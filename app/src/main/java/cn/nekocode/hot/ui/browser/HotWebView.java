...
public class HotWebView extends WebView {
    ...
    public HotWebView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public HotWebView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
